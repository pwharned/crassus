...
object CaseClassGeneratorPlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    val caseClassOutputDir = settingKey[Option[File]]("Output directory for generated classes")
    ...
    val schemaFile = settingKey[String]("The path to the schema file relative to the project directory")
  }
  ...
  override lazy val projectSettings = Seq(
    ...
    caseClassOutputDir := Some(caseClassOutputDir.value.getOrElse ( ((Compile / sourceManaged).value / "generated"))),
