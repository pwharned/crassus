...
/** Binds values of a case-class (CC) to a PreparedStatement for INSERT. Skips
  * any field whose type is PrimaryKey[_]. Returns the “next” parameter index
  * after binding all non-PKs.
  */
