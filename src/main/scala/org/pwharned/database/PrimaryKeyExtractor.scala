...
object PrimaryKeyExtractor:
  ...
  inline def tupleFilterKeys[T <: Tuple](labels: List[String]): Seq[String] =
    ...
    inline erasedValue[T] match
      ...
      case _: (PrimaryKey[String] *: t) => labels.head +: tupleFilterKeys[t](labels.tail)
      case _: (Option[PrimaryKey[String]] *: t) => labels.head +: tupleFilterKeys[t](labels.tail)
      case _: (PrimaryKey[java.util.UUID] *: t) => labels.head +: tupleFilterKeys[t](labels.tail)
      case _: (Option[PrimaryKey[java.util.UUID]] *: t) => labels.head +: tupleFilterKeys[t](labels.tail)
